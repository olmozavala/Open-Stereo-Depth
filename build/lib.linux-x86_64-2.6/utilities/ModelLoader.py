...
class loader:
    ...
    def draw(self,size):
        ...
        for tri in self.get_triangles():            
            ...
            glVertex3f(tri.points[0].x*size,tri.points[0].y*size,tri.points[0].z*size)
            glVertex3f(tri.points[1].x*size,tri.points[1].y*size,tri.points[1].z*size)
            glVertex3f(tri.points[2].x*size,tri.points[2].y*size,tri.points[2].z*size)
        glEnd()
